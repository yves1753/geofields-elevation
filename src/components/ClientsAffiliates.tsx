        ...
        <Reveal>
          <div className="max-w-3xl text-center mx-auto">
            ...
            <p className="mt-4 text-muted-foreground leading-relaxed">
              We are proud to work alongside industry leaders, government agencies and strategic
              partners who share our commitment to responsible mining and exploration across Africa.
            </p>
          </div>
        </Reveal>
        ...
        <div className="mt-14">
          ...
          <div className="group overflow-hidden rounded-sm bg-white p-4 md:p-8 transition-all duration-500 ease-in-out hover:shadow-card focus-within:shadow-card">
            <OptimizedImage
              ...
              sizes="(min-width: 1280px) 1152px, calc(100vw - 72px)"
            />
          </div>
        </div>
